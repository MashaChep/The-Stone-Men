...
CATEGORIES = {
    'meat': ['говядина', 'корова', 'як', 'баранина', 'свинина', 'конина'],
    'fish': ['анчоусы', 'вобла', 'горбуша', 'ерш', 'карась', 'карп', 'зубатка', 'кета', 'корюшка', 'мойва'],
    'milk': ['яйца куриные', 'яйца перепелиные', 'молоко', 'сливки', 'кефир', 'сметана']
}
